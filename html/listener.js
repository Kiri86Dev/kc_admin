...
function warnSomeone(id, reason) {
    ...
    if (n <= 1) {
        document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("success", n);
    }
    else if (n == 2) {
        document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("warning", n);
    }
    else if (n >= 3) {
...
function addWarns(warn_data) {
    ...
    if (warn_data == undefined) {
        document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("success", 0);
        return;
    }

    if (warn_data.length <= 1) {
        document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("success", warn_data.length);
    }
    else if (warn_data.length == 2) {
        document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("warning", warn_data.length);
    }
    else if (warn_data.length >= 3) {
        document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("danger", warn_data.length);
    }
...
function Client() {
    ...
    document.getElementById("warn_n").innerHTML = "Total warns: " + Badge("info", "Loading...");
    ...
    visibility_button.innerText = "Invisibility";
    ...
    freeze_button.innerText = "Freeze";
    ...
    var groups = ["user", "helper", "mod", "admin", "superadmin"];
